document.addEventListener("DOMContentLoaded", function() {
    const buttonAbrir = document.querySelector(".salvar");
    
    // Acessar o modal (EXPORTADO)
    const modalContainer = document.querySelector("main-configuracao-autoatendimento");
...
class Modal_Configuracao_Autoatendimento extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
...
customElements.define('main-configuracao-autoatendimento', Modal_Configuracao_Autoatendimento);