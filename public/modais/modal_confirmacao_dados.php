<div class="fundo-container-confirmacao-dados">
    <section class="modal-confirmacao-dados">
        <img src="../../public/img/icons/logo_control.svg" alt="Logo Nota Control" class="logo-confirmacao-dados">
        ...
        <div class="button-group-confirmacao-dados">
            <button id="btn_ok" class="botao-modal-confirmacao-dados Okay_ConfDados">OK</button>
        </div>
    </section>
</div>