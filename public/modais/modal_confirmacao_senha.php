<div class="fundo-container-confirmacao-senha">
    <section class="modal-confirmacao-senha">
        <img src="../../public/img/icons/logo_control.svg" alt="Logo Nota Control" class="logo-confirmacao-senha">
        ...
        <p class="modal-message-confirmacao-senha"><b>Código enviado com sucesso para o email informado</b></p>
