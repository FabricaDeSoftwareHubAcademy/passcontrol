<div class="modal-overlay fundo-container-confirmacao-dados-registrados" data-nome-modal="confirmar">
    <section class="modal-confirmacao-dados-registrados">
        <img src="../../public/img/icons/logo_control.svg" alt="Logo Nota Control" class="logo-confirmacao-dados-registrados">
