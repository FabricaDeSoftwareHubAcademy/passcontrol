...
<div class="fundo-container-cad-servico" data-nome-modal="cadastrar">
    <section class="modal-servico">
        ...
        <hr class="linha-horizontal-servico-cadastrar">
        ...
        <form id="formulario_cadastrar_servico" method="POST" enctype="multipart/form-data">
            ...
            <div class="servico-ponto-atendimento">
                <label class="label-servico"><b>Código</b></label>
            ...
            <div class="servico-ponto-atendimento">
                <label class="label-servico"><b>Cadastrar Imagem Serviço</b></label>
                <img id="preview_imagem_cadastrar" src="#" alt="Sem Imagem" class="manipula-img-cadastrar">
