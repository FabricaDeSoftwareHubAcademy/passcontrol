...
<body>
    ...
    <main class="workspace">
        ...
        <div class="area-cinza">
                ...
                <div class="footer">
                    <button class="button">
                        <a href="../../usuario/view/tela_autoatendimentoPage3.php" class="btn-voltar">VOLTAR</a>
                    </button>   
                    <button class="button">
                        <a href="../../usuario/view/tela_autoatendimentoPage5.php" class="btn-confirmar">CONFIRMAR</a>
                    </button>   
                </div>
