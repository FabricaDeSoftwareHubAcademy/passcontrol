document.addEventListener("DOMContentLoaded", function() {
    const buttonAbrir = document.querySelector(".botao2");
    
    // Acessar o modal (EXPORTADO)
    const modalContainer = document.querySelector("main-edicao-usuario");
...
class Modal_Edição_Usuario extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
...
customElements.define('main-edicao-usuario', Modal_Edição_Usuario);