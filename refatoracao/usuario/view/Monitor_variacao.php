...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="../../../public/css/monitor-senhas-variacao.css">
    ...
    <section class="fundo-de-tudo">
        <div class="fundo-azul-lateral">
            ...
            <div class="area-das-senhas">
                ...
                <div class="caixa-das-senhas-preferencial">
                    <h2>NOME DA PESSOA</h2>
                    <div class="conjunto-senhas">
                        <div class="senha">
                            <h3>SENHA:</h3>
        ...
        <div class="fundo-senha-principal">
            <div class="fundo-senha-principal-wrap">
                ...
                <div class="infos-senha-principal">
                    <li><h2>SENHA:</h2> <h3>Preferencial</h3><span>CM 005</span></li>
                    <li><h2>GUICHÊ:</h2> <span>12</span></li>
                </div>
                <div class="nome-servico">
                    <li><h2>SERVIÇO:</h2> <span>IPTU</span></li>
                </div>
            </div>
        </div>
    </section>
